           ...
           <div className="bg px-6 py-5 relative shadow-xl">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2 items-center">
                        <Link className="w-9 h-9 bg-white border-2 border-gray-100 rounded-full mt-5 flex justify-center items-center" to={"#"}>
                            <img src="/share.png" className="w-4 h-5"></img>
                        </Link>
                        <Link className="w-9 h-9 bg-white border-2 border-gray-100 rounded-full mt-5 flex justify-center items-center" to={"#"}>
                            <img src="/saved-black.svg" className="w-5 h-4"></img>
                        </Link>
                    </div>
                </div>
                <div className="flex justify-center items-center">
                    <Link to="#" className="w-40 h-11 bg-gray-700 bg-opacity-20 rounded-lg mt-6 flex justify-center items-center" style={{ backdropFilter: 'blur(6px)' }}>
                        <div className="flex justify-center items-center gap-2">
                            <img src="/play.png" className="w-7 h-7"></img>
                            <p className="text-white text-sm ff-Inter">Course Preview</p>
                        </div>
                    </Link>
                </div>
            </div>
            <div className="bg-white w-96 h-[118%] border border-white rounded-tl-3xl rounded-tr-3xl absolute top-[38%] z-10 shadow-2xl">
                <div className="py-4 px-5">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-1 justify-center items-center">
                            <img src="/star.png" className="w-5 h-5"></img>
                            <h3 className="text-sm text-gray-500"> 4.5 (365 reviews) </h3>
                        </div>
                    </div>
                    <h1 className="text-xl ff-Inter font-medium mt-4">Design Thinking Fundamental</h1>
                    <div className="flex justify-start gap-6 items-center">
                        <div className="flex justify-start items-center gap-1 mt-2">
                            <img src="/user.jpg" className="w-4 h-4"></img>
                            <h1 className="text-gray-500 text-xs ff-Inter">Robert Green</h1>
                        </div>
                        <div className="flex justify-start items-center gap-1 mt-2">
                            <img src="/play-gray.png" className="w-4 h-4"></img>
                            <h1 className="text-gray-500 text-xs ff-Inter">32 Lessons</h1>
                        </div>
                        <div className="flex justify-start items-center mt-2">
                            <img src="/certification.jpg" className="w-6 h-6"></img>
                            <h1 className="text-gray-500 text-xs ff-Inter">Certificate</h1>
                        </div>
                    </div>
                    <div className="mt-5 flex justify-center px-5 gap-16 items-center">
                        <Link to={"/courseDetail/about"}><h1 className="text-gray-500 ff-Inter text-sm">About</h1></Link>
                        <Link to={"/courseDetail/lessons"}><h1 className="text-gray-500 ff-Inter text-sm">Lessons</h1></Link>
                        <Link to={"/courseDetail/reviews"}><h1 className="text-blue-700 ff-Inter font-medium text-sm">Reviews</h1></Link>
                    </div>
                </div>
                <div className="h-[0.01rem] w-full bg-gray-200 relative"></div>
                <div className="absolute bg-blue-700 rounded-tl-xl rounded-tr-xl w-24 h-[0.25rem] top-[22.6%] left-[66.8%]"></div>
                <div className="py-4 px-5">
                    <div className="flex gap-1 items-center mt-2"><h2 className="ff-Inter font-medium text-gray-900 text-sm">Review</h2><span className="text-sm text-blue-700 font-semibold ff-Inter">(45)</span></div>
                    <SearchBar className="w-full h-10 bg-slate-100 mt-4 px-10 rounded-lg" placeholderText={"Search in reviews"} iconTop={"32%"} iconLeft={"7.5%"}/>
                    <div className="flex justify-between items-center mt-4 w-[105%]">
                        <div className="bg-slate-100 w-20 h-7 rounded-2xl flex justify-center items-center gap-1">
                            <img src="/filter-black.svg" className="w-4 h-4"></img>
                            <h1 className="text-xs ff-Inter font-medium">Filter</h1>
                            <img src="/triangle.png" className="w-2 h-1 mt-1"></img>
                        </div>
                        <div className="bg-blue-600 w-[4.5rem] h-7 rounded-2xl flex justify-center items-center gap-1">
                            <h1 className="text-xs ff-Inter font-medium text-white">Vertified</h1>
                        </div>
                        <div className="bg-blue-600 w-[3.5rem] h-7 rounded-2xl flex justify-center items-center gap-1">
                            <h1 className="text-xs ff-Inter font-medium text-white">Latest</h1>
                        </div>
                        <div className="bg-slate-100 w-[7.5rem] h-7 rounded-2xl flex justify-center items-center gap-1">
                            <h1 className="text-xs ff-Inter font-medium">Detailed Reviews</h1>
                        </div>
                    </div>
                </div>
                <div className="h-[0.01rem] w-full bg-gray-200 relative mt-2"></div>
                <div className="flex flex-col justify-between items-start gap-3 px-6 mt-5 ">
                    <div className="flex items-center gap-2">
                        <img src="/person5.jpg" className="rounded-full w-10 h-10 relative"></img>
                        <h1 className="text-gray-900 text-sm font-semibold ff-Inter">Dale Thiel</h1>
                        <p className="text-gray-500 text-xs ml-[7.8rem] font-medium ff-Inter">11 months ago</p>
                        <img src="/verified-badge.png" className="absolute w-[1rem] h-[1rem] top-[51.5%] left-[13.8%]"></img>
                    </div>
                    <p className="text-xs text-gray-500 f">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad tenetur exercitationem cum nesciunt.</p>
                    <div className="flex items-center gap-1">
                        <img src="/star.png" className="w-4 h-4"></img>
                        <img src="/star.png" className="w-4 h-4"></img>
                        <img src="/star.png" className="w-4 h-4"></img>
                        <img src="/star.png" className="w-4 h-4"></img>
                        <img src="/star.png" className="w-4 h-4"></img>
                        <p className="text-sm font-medium ff-Inter text-gray-800">5.0</p>
                    </div>
                </div>
                <div className="h-[0.01rem] w-full bg-gray-200 relative mt-2"></div>
                <div className="flex flex-col justify-between items-start gap-3 px-6 mt-5 ">
                    <div className="flex items-center gap-2">
                        <img src="/person6.jpg" className="rounded-full w-10 h-10 relative"></img>
                        <h1 className="text-gray-900 text-sm font-semibold ff-Inter">Tiffany Nitzsche</h1>
                        <p className="text-gray-500 text-xs ml-[5.2rem] font-medium ff-Inter">11 months ago</p>
                        <img src="/verified-badge.png" className="absolute w-[1rem] h-[1rem] top-[70.8%] left-[14%]"></img>
                    </div>
                    <p className="text-xs text-gray-500 f">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad tenetur exercitationem cum nesciunt.</p>
                    <div className="flex items-center gap-1">
                        <img src="/star.png" className="w-4 h-4"></img>
