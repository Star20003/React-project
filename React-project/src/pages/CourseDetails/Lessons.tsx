    ...
    return ( 
        <>
           <div className="bg px-6 py-5 relative shadow-xl">
            ...
            <div className="bg-white w-96 h-[107%] border border-white rounded-tl-3xl rounded-tr-3xl absolute top-[38%] z-10 shadow-2xl">
                <div className="py-4 px-5">
                    ...
                    <div className="mt-5 flex justify-center px-5 gap-16 items-center">
                        ...
                        <Link to={"/courseDetail/lessons"}><h1 className="text-blue-700 font-medium ff-Inter text-sm">Lessons</h1></Link>
                        <Link to={"/courseDetail/reviews"}><h1 className="text-gray-500 ff-Inter text-sm">Reviews</h1></Link>
                    </div>
                </div>
                <div className="h-[0.01rem] w-full bg-gray-200 relative"></div>
                <div className="absolute bg-blue-700 rounded-tl-xl rounded-tr-xl w-24 h-[0.25rem] top-[25%] left-[35.5%]"></div>
                <div className="py-4 px-5">
                    <div className="flex gap-1 items-center mt-2"><h2 className="ff-Inter font-medium text-gray-900 text-sm">Lessons</h2><span className="text-sm text-blue-700 font-semibold ff-Inter">(32)</span></div>
                    <div className="flex flex-col items-start justify-center">
                        <div className="flex justify-start items-center mt-4 gap-24">
                            <h2 className="ff-Inter font-medium text-gray-500 text-sm w-48">Section 1 - Introduction</h2>
                            <h2 className="text-sm text-blue-700 font-semibold ff-Inter">15 Min</h2>
                        </div>
                        <div className="flex flex-col gap-2 mt-4">
                            <div className="w-[21rem] h-12 border-2 rounded-3xl border-gray-300 bg-white flex justify-start items-center p-1">
                                <div className="bg-blue-600 bg-opacity-15 rounded-full w-[2.4rem] h-[2.4rem] flex justify-center items-center font-semibold"><h1 className="text-blue-800">01</h1></div>
                            ...
                            <div className="w-[21rem] h-12 border-2 rounded-3xl border-gray-300 bg-white flex justify-start items-center p-1">
                                ...
                                <div className="flex justify-center items-start flex-col ml-2">
                                    <h1 className="text-sm ff-Inter font-bold">Empathy in Design</h1>
                                    <h1 className="text-gray-500 text-xs ff-Inter font-medium">05:00</h1>
                                </div>
                                <img src="/lock.png" className="w-6 h-6 ml-[7.3rem]"></img>
                            </div>
                        </div>
                        <div className="flex justify-start items-center mt-5 gap-24">
                            <h2 className="ff-Inter font-medium text-gray-500 text-sm w-48">Section 2 - Fundamentals</h2>
                            <h2 className="text-sm text-blue-700 font-semibold ff-Inter">45 Min</h2>
                        </div>
                        <div className="flex flex-col gap-2 mt-4">
                            <div className="w-[21rem] h-12 border-2 rounded-3xl border-gray-300 bg-white flex justify-start items-center p-1">
                                <div className="bg-blue-600 bg-opacity-15 rounded-full w-[2.4rem] h-[2.4rem] flex justify-center items-center font-semibold"><h1 className="text-blue-800">03</h1></div>
                                <div className="flex justify-center items-start flex-col ml-2">
                                    <h1 className="text-sm ff-Inter font-bold">Ideation and Brainstorming</h1>
                                    <h1 className="text-gray-500 text-xs ff-Inter font-medium">25:00</h1>
                                </div>
                                <img src="/lock.png" className="w-6 h-6 ml-[3.75rem]"></img>
                            </div>
                            <div className="w-[21rem] h-12 border-2 rounded-3xl border-gray-300 bg-white flex justify-start items-center p-1">
                                <div className="bg-blue-600 bg-opacity-15 rounded-full w-[2.4rem] h-[2.4rem] flex justify-center items-center font-semibold"><h1 className="text-blue-800">04</h1></div>
                                <div className="flex justify-center items-start flex-col ml-2">
                                    <h1 className="text-sm ff-Inter font-bold">Prototyping and Testing</h1>
                                    <h1 className="text-gray-500 text-xs ff-Inter font-medium">10:00</h1>
                                </div>
                                <img src="/lock.png" className="w-6 h-6 ml-[5.1rem]"></img>
                            </div>
                            <div className="w-[21rem] h-12 border-2 rounded-3xl border-gray-300 bg-white flex justify-start items-center p-1">
                                <div className="bg-blue-600 bg-opacity-15 rounded-full w-[2.4rem] h-[2.4rem] flex justify-center items-center font-semibold"><h1 className="text-blue-800">05</h1></div>
                                <div className="flex justify-center items-start flex-col ml-2">
                                    <h1 className="text-sm ff-Inter font-bold">Empathy in Design</h1>
                                    <h1 className="text-gray-500 text-xs ff-Inter font-medium">05:00</h1>
                                </div>
                ...
                <div className="rounded-tl-2xl rounded-tr-2xl w-full h-10 border-t-2 flex flex-col z-50 bg-white bg-opacity-100 absolute top-[84%]" style={{ boxShadow: "0px -5px 15px rgba(0, 0, 0, 0.1)" }}>
