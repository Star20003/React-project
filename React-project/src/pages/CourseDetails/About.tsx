            ...
            <div className="bg-white w-96 h-[118%] border border-white rounded-tl-3xl rounded-tr-3xl absolute top-[38%] z-10 shadow-2xl">
                <div className="py-4 px-5">
                    ...
                    <div className="mt-5 flex justify-center px-5 gap-16 items-center">
                        <Link to={"/courseDetail/about"}><h1 className="text-blue-700 font-medium ff-Inter text-sm">About</h1></Link>
                    ...
                    <div className="mt-3 flex justify-start items-center">
                        ...
                        <div className="flex justify-center items-center gap-16">
                            <div className="flex flex-col justify-center items-start ml-4">
                                <h1 className="text-gray-900 font-semibold ff-Inter">Robert Green</h1>
                                <h3 className="text-gray-500 ff-Inter text-xs">Design Tutor</h3>
                            </div>
                            <div className="flex justify-center items-center gap-5">
                                <Link to={"#"}><div className="bg-gray-200 w-10 h-10 rounded-full flex justify-center items-center"><img className="w-5 h-5" src="/phone.png"></img></div></Link>
                                <Link to={"#"}><div className="bg-gray-200 w-10 h-10 rounded-full flex justify-center items-center"><img className="w-6 h-6" src="/chat-blue.png"></img></div></Link>
                            </div>
                        </div>
                    </div>
                    <h1 className="mt-7 ff-Inter text-sm font-medium">Info</h1>
                    <div className="flex flex-col items-start justify-center mt-3 gap-4">
                        <div className="flex justify-between items-center gap-32">
                            <div className="flex flex-col justify-center items-start">
                                <h2 className="text-sm text-gray-500 ff-Inter font-medium">Students</h2>
                                <h2 className="text-sm text-gray-900 ff-Inter font-medium">156,213</h2>
                            </div>
                            <div className="flex flex-col justify-center items-start">
                                <h2 className="text-sm text-gray-500 ff-Inter font-medium">Language</h2>
                                <h2 className="text-sm text-gray-900 ff-Inter font-medium">English</h2>
                            </div>
                        </div>
                        <div className="flex justify-between items-center gap-28">
                            <div className="flex flex-col justify-center items-start">
                                <h2 className="text-sm text-gray-500 ff-Inter font-medium">Last update</h2>
                                <h2 className="text-sm text-gray-900 ff-Inter font-medium">Feb 2, 2023</h2>
                            </div>
                            <div className="flex flex-col justify-center items-start">
                                <h2 className="text-sm text-gray-500 ff-Inter font-medium">Subtitle</h2>
                                <div className="flex gap-1"><span className="text-sm text-gray-900 ff-Inter font-medium">English and </span><Link to={"#"} className="text-blue-700 text-sm ff-Inter font-medium"> 5 more</Link></div>
                            </div>
                        </div>
                        <div className="flex justify-between items-center gap-32">
                            <div className="flex flex-col justify-center items-start">
                                <h2 className="text-sm text-gray-500 ff-Inter font-medium">Level</h2>
                                <h2 className="text-sm text-gray-900 ff-Inter font-medium">Beginner</h2>
                            </div>
                            <div className="flex flex-col justify-center items-start">
                                <h2 className="text-sm text-gray-500 ff-Inter font-medium">Access</h2>
                                <h2 className="text-sm text-gray-900 ff-Inter font-medium">Mobile, Desktop</h2>
                            </div>
                        </div>
                    </div>
                </div>
