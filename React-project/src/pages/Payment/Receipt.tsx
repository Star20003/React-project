...
const Receipt: FC = () => {
  return (
    <>
      ...
      <div className="flex justify-between items-center mt-6 gap-16">
        <Link className="w-10 h-10 bg-white border-2 border-gray-200 rounded-full flex justify-center items-center" to={"/pay/paymentSuccess"}>
          <img src="/black-arrow.png" className="w-5 h-3"></img>
        </Link>
        <p className="font-semibold ff-Inter text-gray-600">E-Receipt</p>
        <Link className="w-10 h-10 bg-white border-2 border-gray-200 rounded-full flex justify-center items-center" to={""}>
          <img src="/share.png" className="w-[1.1rem] h-[1.2rem]"></img>
        </Link>
      </div>
      ...
      <div className="flex flex-col mt-3">
        <div className="flex justify-between items-center mt-2">
            <p className="font-medium text-sm text-gray-500 ff-Inter">Purchase Date</p>
            <p className="font-semibold text-sm ff-Inter text-gray-800">Agust 24, 2023 | 10:00 AM</p>
        </div>
        <div className="flex justify-between items-center mt-2">
            <p className="font-medium text-sm text-gray-500 ff-Inter">Mentor</p>
            <p className="font-semibold text-sm ff-Inter text-gray-800">Jacob Jones</p>
        </div>
        <div className="flex justify-between items-center mt-2">
      ...
      <div className="flex flex-col mt-3">
        <div className="flex justify-between items-center mt-2">
            <p className="font-medium text-sm text-gray-500 ff-Inter">Payment Method</p>
            <p className="font-semibold text-sm ff-Inter text-gray-800">Paypal</p>
        </div>
        <div className="flex justify-between items-center mt-2">
            <p className="font-medium text-sm text-gray-500 ff-Inter">Payment Status</p>
            <p className="font-semibold text-sm ff-Inter text-gray-800">Paid</p>
        </div>
        <div className="flex justify-between items-center mt-2 mb-12">
            <p className="font-medium text-sm text-gray-500 ff-Inter">Transaction ID</p>
            <p className="font-semibold text-sm ff-Inter text-gray-800">#RE2564HG23</p>
        </div>
      </div>

      <div className="rounded-tl-2xl rounded-tr-2xl w-96 h-28 border-t-2 flex flex-col justify-center z-50 bg-white bg-opacity-100 absolute top-[110%] left-[36.1%]" style={{ boxShadow: "0px -5px 15px rgba(0, 0, 0, 0.1)" }}>
        <Link to={"/pay/paymentSuccess"} className="px-5"><Button Text={"Download E-Receipt"} className="h-12 mt-2 w-full"></Button></Link>
