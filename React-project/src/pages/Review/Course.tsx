    ...
    return ( 
        <>
           <div className="bg px-6 py-5 relative shadow-xl">
            ...
            <div className="bg-white w-96 h-[88%] border border-white rounded-tl-3xl rounded-tr-3xl absolute top-[22.5%] z-10 shadow-2xl">
                <div className="py-4 px-5">
                    ...
                    <div className="h-[0.01rem] w-full bg-gray-200 mt-5 relative"></div>
                </div>
                <div className="flex flex-col justify-center items-center">
                    <p className="text-gray-500 text-xs mt-4 ff-Inter">Your overall rating for this course</p>
                ...
                <div className="flex flex-col gap-1 justify-start px-6 mt-7">
                    ...
                    <textarea className="w-full h-32 border border-gray-300 p-1 px-3 rounded-lg mt-1" placeholder="Enter here"></textarea>
                </div>

                <div className="rounded-tl-2xl rounded-tr-2xl w-96 h-28 border-t-2 flex flex-col justify-center z-50 bg-white bg-opacity-100 absolute top-[92%]" style={{ boxShadow: "0px -5px 15px rgba(0, 0, 0, 0.1)" }}>
