...
const Signup: FC = () => {
  ...
  return (
    <>
        ...
        <div className="justify-center flex-col flex items-center mt-12">
            <h1 className="text-2xl font-semibold ">Create Account</h1>
            <div className="flex flex-col justify-center items-center">
                <p className="mt-3 text-xs text-gray-500 ff-Inter">Fill your information below or register</p>
        ...
        <div className="flex items-center justify-center mt-8">
          ...
          <Link className="text-blue-600 dark:text-blue-500 font-semibold text-sm underline ml-1" to={"/auth/login"}>Sign In</Link>
        </div>
