...
const Login: FC = () => {
  ...
  return (
    <>
        ...
        <div className="justify-center flex-col flex items-center mt-20">
        ...
        <div className="flex items-center justify-center mt-8">
          ...
          <Link className="text-blue-600 dark:text-blue-500 font-semibold text-sm underline ml-1" to={"/auth/signup"}>Sign Up</Link>
        </div>
